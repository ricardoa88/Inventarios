...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser :IdentityUser
    {
        ...
        {
            string commandText = "Select username from usuarios where Id = @id";
        ...
        {
            string commandText = "Select Id from usuarios where UserName = @name";
        ...
        public List<TUser> GetUserByName(string userName)
        {
            ...
            string commandText = "Select * from usuarios where UserName = @name";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@name", userName } };
        ...
        {
            string commandText = "Select PasswordHash from usuarios where Id = @id";
        ...
        {
            string commandText = "Update usuarios set PasswordHash = @pwdHash where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = "Select SecurityStamp from usuarios where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@id", userId } };
        ...
        {
            string commandText = @"Insert into usuarios (UserName, Id, PasswordHash, SecurityStamp,Email,EmailConfirmed,PhoneNumber,PhoneNumberConfirmed, AccessFailedCount,LockoutEnabled,LockoutEndDateUtc,TwoFactorEnabled)
        ...
        {
            string commandText = "Delete from usuarios where Id = @userId";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = @"Update usuarios set UserName = @userName, PasswordHash = @pswHash, SecurityStamp = @secStamp, 
